...
export class AutenticaService {
     ...
     signupUser(email: string, password: string) {
      return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyArK2EhPPVuUzl3kXPN1ScbuxSE9aWhTMI', 
      {
         email: email,
         password: password,
     ...
     loginUser(email: string, password: string) {
       return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyArK2EhPPVuUzl3kXPN1ScbuxSE9aWhTMI',
       {
         email: email,
         password: password,
         returnSecureToken: true
